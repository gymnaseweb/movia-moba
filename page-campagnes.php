...
<main class="nos_projets_page ">
  <div class="max_container ">
    <div class="nos_projets_title events_page_title">
  ...
  <section class="sec_filter_nos">
    <div class="max_container ">
      <div class="div_filter_nos">
        <div class="div_toggle_filter ">
            <button class="btn_toggle_filter">Filtres <span class="">×</span></button>
        </div>
        <?php
        ...
        <div class="filter-list grid_projets_boxes grid_events_boxes" role="list" id="filter-list">
          <?php if ($q->have_posts()): ?>
            <?php
            ...
            ?>
              <div class="projet_box event_box filter-list__item"
                  role="listitem"
                  data-filter-status="active"
                  data-filter-name="">
                ...
                <div class="projet_info event_info">
                  <div class="projet_tags event_tags">
                    <ul>
                      <?php
                      foreach ($tax_names as $tname) {
